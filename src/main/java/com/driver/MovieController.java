...
public class MovieController {
    ...
    public ResponseEntity<Movie> getMovie(@PathVariable("movie") String movie) {
    ...
    public ResponseEntity<List<String>> getMovieFromDirector(@PathVariable("director") String director) {
